...
public class FuncionalidadesControl : MonoBehaviour {
	...
	public void salvarGame(){
		string salvarDado =   
							...
							+ GameManager.simulador.custoSucoLaranjaCopo.ToString() + ";"
							+ GameManager.simulador.custoSucoLaranjaGelo.ToString() + ";"
							+ GameManager.simulador.custoSucoLimaoCopo.ToString() + ";"
							+ GameManager.simulador.custoSucoLimaoGelo.ToString() + ";"
							+ GameManager.simulador.custoSucoPessegoCopo.ToString() + ";"
							+ GameManager.simulador.custoSucoPessegoGelo.ToString() + ";"
							+ GameManager.simulador.custoSucoTamarindoCopo.ToString() + ";"
							+ GameManager.simulador.custoSucoTamarindoGelo.ToString() + ";"
							+ GameManager.simulador.custoSucoUvaCopo.ToString() + ";"
							+ GameManager.simulador.custoSucoUvaGelo.ToString() + ";"
